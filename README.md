...
> This tool is an **unofficial helper** built for personal use. The cutoff data is sourced from publicly available KEA documents. Always verify data against the [official KEA website](https://cetonline.karnataka.gov.in) before making final option entry decisions.
